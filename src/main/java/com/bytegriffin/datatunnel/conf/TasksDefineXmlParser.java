...
public class TasksDefineXmlParser {
    ...
    public List<TaskDefine> load() {
        ...
        taskElements.stream().filter(subElement -> subElement != null).forEach(subElement -> {
            ...
            readers.stream().filter(ele -> ele != null).forEach(ele -> {
            ...
            writers.stream().filter(ele -> ele != null).forEach(ele -> {
