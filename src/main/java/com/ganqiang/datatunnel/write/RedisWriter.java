...
public class RedisWriter implements Process{

	private static final Logger logger = Logger.getLogger(RedisWriter.class);
	
	@Override
	public void execute(Param param) {
		logger.info("task "+Thread.currentThread().getName()+" redis start to write... ");
		...
		logger.info("task "+Thread.currentThread().getName()+" redis write finish.");
	}
