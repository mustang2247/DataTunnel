...
public class HdfsWriter implements Process{

	private static final Logger logger = Logger.getLogger(HdfsWriter.class);

	@Override
	public void execute(Param param) {
		logger.info("task "+Thread.currentThread().getName()+" hdfs start to write... ");
		...
		logger.info("task "+Thread.currentThread().getName()+" hdfs write finish.");
	}
