...
public class RedisReader implements Process{
	
	private static final Logger logger = Logger.getLogger(RedisReader.class);

	@Override
	public void execute(Param param) {
		logger.info("task "+Thread.currentThread().getName()+" redis start to read... ");
		...
		logger.info("task "+Thread.currentThread().getName()+" redis read finish.");
	}
