...
public class HdfsReader implements Process{
	
	private static final Logger logger = Logger.getLogger(HdfsReader.class);

	@Override
	public void execute(Param param) {
		logger.info("task "+Thread.currentThread().getName()+" hdfs start to read... ");
		...
		logger.info("task "+Thread.currentThread().getName()+" hdfs read finish.");
	}
